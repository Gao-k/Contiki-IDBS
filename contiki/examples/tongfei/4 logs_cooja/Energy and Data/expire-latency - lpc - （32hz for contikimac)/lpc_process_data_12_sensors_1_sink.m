...
function [ ] = lpc_process_data_12_sensors_1_sink( file_in )
%UNTITLED 此处显示有关此函数的摘要
%   此处显示详细说明
%%
%file_in = 'lpc_tempdata.txt';
output1 = 'processeddata/lpc_grade_1.txt';
output2 = 'processeddata/lpc_grade_2.txt';
output3 = 'processeddata/lpc_grade_3.txt';
output4 = 'processeddata/lpc_grade_4.txt';
output5 = 'processeddata/lpc_grade_5.txt';
