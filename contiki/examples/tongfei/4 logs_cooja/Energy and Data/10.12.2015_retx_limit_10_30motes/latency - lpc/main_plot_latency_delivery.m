...
AX = legend([pdc_sf4_latency pdc_sf7_latency pdc_sf10_latency cc32hz_noRDC_latency ], ...
    'PDC (SF=4)','PDC (SF=7)','PDC (SF=10)','CTP-Full Active',1);%设置legend位置。
...
'PDC (SF=4)','PDC (SF=7)','PDC (SF=10)','CTP-Full Active','CTP-CMAC-16Hz','CTP-CMAC-32Hz','CTP-CMAC-64Hz','CTP-XMAC',4);%设置legend位置。
LEG = findobj(AX,'type','text');
axis([10 50 0 1.001]);
set(LEG,'FontSize',11);%设置legend字体大小
set(gca,'FontSize',16);%设置坐标字体大小
