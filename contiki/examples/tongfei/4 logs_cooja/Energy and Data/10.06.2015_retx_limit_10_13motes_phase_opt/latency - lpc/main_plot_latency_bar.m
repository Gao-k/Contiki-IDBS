...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
lpc_process_data_12_sensors_1_sink( 'rawdata/lpc_tempdata.txt' ); % process the raw obtained data
...
lpc_latency_array=lpc_latency_array./128;
%bar(latency_array);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
contikiCollect_process_data_12_sensors_1_sink( 'rawdata/contikiCollect_tempdata_1.txt' ); % process the raw obtained data
...
contikiCollect_latency_array_1=contikiCollect_latency_array_1./128;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
contikiCollect_latency_array_2=contikiCollect_latency_array_2./128;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
contikiCollect_latency_array_3=contikiCollect_latency_array_3./128;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
