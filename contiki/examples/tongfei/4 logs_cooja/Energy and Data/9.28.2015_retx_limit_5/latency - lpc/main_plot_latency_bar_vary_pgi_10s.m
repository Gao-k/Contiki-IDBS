...
pdc_latency_1s = plot(grade,pdc_latency_array_pgi_1s,pdc_1s);
hold on;
cc_latency_1s = plot(grade,cc_latency_array_pgi_1s,cc_1s);

% pdc_latency_6s = plot(grade,pdc_latency_array_pgi_6s,pdc_6s);
% cc_latency_6s = plot(grade,cc_latency_array_pgi_6s,cc_6s);

pdc_latency_11s = plot(grade,pdc_latency_array_pgi_11s,pdc_11s);
cc_latency_11s = plot(grade,cc_latency_array_pgi_11s,cc_11s);

% pdc_latency_16s = plot(grade,pdc_latency_array_pgi_16s,pdc_16s);
% cc_latency_16s = plot(grade,cc_latency_array_pgi_16s,cc_16s);

pdc_latency_21s = plot(grade,pdc_latency_array_pgi_21s,pdc_21s);
cc_latency_21s = plot(grade,cc_latency_array_pgi_21s,cc_21s);
box on;
...
figure;
pdc_data_num_1s=plot(grade,pdc_total_data_num_pgi_1s./node_num_at_each_grade,pdc_1s);
hold on;
cc_data_num_1s = plot(grade,cc_total_data_num_pgi_1s./node_num_at_each_grade,cc_1s);

pdc_data_num_11s=plot(grade,pdc_total_data_num_pgi_11s./node_num_at_each_grade,pdc_11s);
cc_data_num_11s = plot(grade,cc_total_data_num_pgi_11s./node_num_at_each_grade,cc_11s);

pdc_data_num_21s=plot(grade,pdc_total_data_num_pgi_21s./node_num_at_each_grade,pdc_21s);
cc_data_num_21s = plot(grade,cc_total_data_num_pgi_21s./node_num_at_each_grade,cc_21s);
