...
src_file_1 = 'ClockDrift2to1.txt';
src_file_2 = 'ClockDrift5to2.txt';
src_file_3 = 'ClockDrift6to2.txt';
src_file_4 = 'ClockDrift7to2.txt';
...
plot(time3/3600,clock_drift,'*');
legend(src_file_1,legend_pos_2);
set(gca,'XTickLabel',' ');
axis([x_from x_end y_from y_end]);
grid on;
%========================================================================================%
...
plot(time3/3600,clock_drift,'*');
legend(src_file_3,legend_pos_3);
set(gca,'XTickLabel',' ');
axis([x_from x_end y_from y_end]);
...
plot(time3/3600,clock_drift,'*');
legend(src_file_4,legend_pos_4);
box on;
axis([x_from x_end y_from y_end]);
