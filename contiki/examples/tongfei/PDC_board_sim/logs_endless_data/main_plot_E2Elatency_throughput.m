...
for ii = file_num
    ...
    adc_18_fa_rcvd_pkt_num(ii) = length(latency);
    ...
    adc_18_fa_avg_delivery(ii) = total_pkt/total_time;
    ...
    adc_18_nfa_avg_delivery(ii) = total_pkt/total_time;
    ...
    pdc_18_nfa_avg_delivery(ii) = total_pkt/total_time;
    ...
    adc_10_fa_avg_delivery(ii) = total_pkt/total_time;
    ...
    adc_10_nfa_rcvd_pkt_num(ii) = length(latency);
    ...
    adc_10_nfa_avg_delivery(ii) = total_pkt/total_time;
    ...
    pdc_10_nfa_rcvd_pkt_num(ii) = length(latency);
    ...
    pdc_10_nfa_avg_delivery(ii) = total_pkt/total_time;
...
AX = legend([adc_10_fa_latency adc_18_fa_latency adc_10_nfa_latency adc_18_nfa_latency pdc_10_nfa_latency pdc_18_nfa_latency ], ...
    'ADC-FA (SL=10)','ADC-FA (SL=18)','ADC-No FA (SL=10)','ADC-No FA (SL=18)','PDC (SL=10)','PDC (SL=18)',0);%设置legend位置。
...
'ADC-FA (SL=10)','ADC-FA (SL=18)','ADC-No FA (SL=10)','ADC-No FA (SL=18)','PDC (SL=10)','PDC (SL=18)',1);%设置legend位置。
LEG = findobj(AX,'type','text');
% axis([0 10 0 1.1]);
set(LEG,'FontSize',11);%设置legend字体大小
set(gca,'FontSize',16);%设置坐标字体大小
...
% AX = legend([pdc_data_num_1s cc_data_num_1s],'PDC (PGI=5s)','CC (PGI=5s)',3);%设置legend位置。
AX = legend([adc_10_fa_delivery adc_18_fa_delivery adc_10_nfa_delivery adc_18_nfa_delivery pdc_10_nfa_delivery pdc_18_nfa_delivery], ...
'ADC-FA (SL=10)','ADC-FA (SL=18)','ADC-No FA (SL=10)','ADC-No FA (SL=18)','PDC (SL=10)','PDC (SL=18)',4);%设置legend位置。
LEG = findobj(AX,'type','text');
% axis([0 10 0 1.1]);
set(LEG,'FontSize',11);%设置legend字体大小
set(gca,'FontSize',16);%设置坐标字体大小
