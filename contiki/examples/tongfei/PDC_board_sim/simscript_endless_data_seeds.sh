...
set Random_seed = 125562
set Sim_times = 3
set UNIT=s
#"/mnt/hgfs/ContikiPro/1LatestContiki/contiki"
set CONTIKIDIR="/home/feitong/Dropbox/ContikiPro/1LatestContiki/contiki"
set SCRIPTDIR="/home/feitong/Dropbox/ContikiPro/1LatestContiki/contiki/examples/tongfei/PDC_board_sim"
...
#set LOGSDIR="$SCRIPTDIR/logs_endless_data_7"
...
while ($Sim_times > 0)
	...
	sleep 0.5s
	set LOGSDIR="$SCRIPTDIR/logs_endless_data_primacBoard_$Random_seed"
