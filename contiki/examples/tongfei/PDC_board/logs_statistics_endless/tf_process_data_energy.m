...
% Date: May 13, 2015
 ...
 function [ ] = tf_process_data_energy( separater )
...
%     output_data_folder = [separater,'_data'];
    ...
    input_data_folder = ['.\logs_5_z1_2_micaz_endless_30m_',int2str(folder)];
    output_data_folder = ['.\logs_5_z1_2_micaz_endless_30m_',int2str(folder),'\',separater,'_data'];
            ...
            for j = 1:1:protocol_num
                ...
                for k = 1:1:fa_num
                    ...
                    for f=1:5
                        ...
                        elseif f==2
                            input_file_name='z2.txt';
                        elseif f==3
                            input_file_name='z3.txt';
                        elseif f==4
                            input_file_name='z4.txt';
                        elseif f==5
                            input_file_name='z5.txt';
                        end
