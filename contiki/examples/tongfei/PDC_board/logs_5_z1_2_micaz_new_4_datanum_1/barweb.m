...
% 	set(gca, 'xticklabel', groupnames, 'box', 'on', 'ticklength', [0 0], 'fontsize', 12, 'xtick',1:numgroups, 'linewidth', 1,'xgrid','off','ygrid','off');
	set(gca, 'xticklabel', groupnames, 'box', 'on', 'ticklength', [0 0], 'fontsize', 12, 'xtick',1:numgroups, 'xgrid','off','ygrid','off');
