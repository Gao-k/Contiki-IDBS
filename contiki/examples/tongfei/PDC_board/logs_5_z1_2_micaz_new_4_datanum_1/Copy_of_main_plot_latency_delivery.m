...
AX = legend([ adc_18_fa_latency    pdc_18_nfa_latency ], ...
   'ADC-FA (SL=18)','PDC (SL=18)',0);%设置legend位置。
...
AX = legend([ adc_18_fa_delivery    pdc_18_nfa_delivery], ...
'ADC-FA (SL=18)','PDC (SL=18)',4);%设置legend位置。
LEG = findobj(AX,'type','text');
axis([0 10 0 1.1]);
set(LEG,'FontSize',11);%设置legend字体大小
set(gca,'FontSize',16);%设置坐标字体大小
