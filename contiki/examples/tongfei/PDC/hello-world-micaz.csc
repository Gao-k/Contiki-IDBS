...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/tongfei/hello-world-micaz.c</source>
      <commands>make hello-world-micaz.elf TARGET=micaz</commands>
      <firmware>[CONTIKI_DIR]/examples/tongfei/hello-world-micaz.elf</firmware>
    ...
    <motetype>
      ...
      <description>MicaZ Mote Type #unicast</description>
      <source>[CONTIKI_DIR]/examples/tongfei/example-unicast.c</source>
      <commands>make example-unicast.elf TARGET=micaz</commands>
      <firmware>[CONTIKI_DIR]/examples/tongfei/example-unicast.elf</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.avrmote.interfaces.MicaZID</moteinterface>
      <moteinterface>org.contikios.cooja.avrmote.interfaces.MicaZLED</moteinterface>
      <moteinterface>org.contikios.cooja.avrmote.interfaces.MicaZRadio</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>79.25632629338621</x>
        <y>84.1160820509666</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>63.76128590585396</x>
        <y>66.86072608227047</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.avrmote.interfaces.MicaZID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>7.855886121162867 0.0 0.0 7.855886121162867 -396.26503737893205 -348.02830581568304</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>649</height>
