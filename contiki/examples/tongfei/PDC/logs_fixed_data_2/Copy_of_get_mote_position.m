xmlDoc = xmlread('ADC-PDC-26z1.csc');
...
figure(1);
plot(coordinates(2:end,1),coordinates(2:end,2),'Ko','MarkerSize',11);
hold on;

plot(coordinates(1,1),coordinates(1,2),'k^','MarkerSize',12,'MarkerFaceColor','r');
axis([0 100 0 100]);
